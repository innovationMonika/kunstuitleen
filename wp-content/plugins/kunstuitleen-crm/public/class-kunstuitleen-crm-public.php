 ...
 * @subpackage Kunstuitleen_Crm/public
 */
...
class Kunstuitleen_Crm_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/kunstuitleen-crm-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/kunstuitleen-crm-public.js', array( 'jquery' ), $this->version, false );
