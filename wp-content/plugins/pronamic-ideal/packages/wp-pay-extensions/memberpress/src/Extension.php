...
class Extension extends AbstractPluginIntegration {
			...
			case PaymentStatus::FAILURE:
				...
				$url = add_query_arg(
					[
						...
						'errors'   => [
							__( 'Payment failed. Please try again.', 'pronamic-ideal' ),
						],
	...
	public function subscription_pre_delete( $subscription_id ) {
		...
		$note = sprintf(
			...
			__( '%s subscription deleted.', 'pronamic-ideal' ),
	...
	public function source_text( $text, Payment $payment ) {
		$text = __( 'MemberPress', 'pronamic-ideal' ) . '<br />';
		...
		$text .= sprintf(
			...
			sprintf( __( 'Transaction %s', 'pronamic-ideal' ), $payment->source_id )
		);
	...
	public function subscription_source_text( $text, Subscription $subscription ) {
		...
		$text .= sprintf(
			...
			sprintf( __( 'Subscription %s', 'pronamic-ideal' ), $subscription->source_id )
		);
	...
	public function source_description( $description, Payment $payment ) {
		return __( 'MemberPress Transaction', 'pronamic-ideal' );
	}
	...
	public function subscription_source_description( $description, Subscription $subscription ) {
		return __( 'MemberPress Subscription', 'pronamic-ideal' );
	}
