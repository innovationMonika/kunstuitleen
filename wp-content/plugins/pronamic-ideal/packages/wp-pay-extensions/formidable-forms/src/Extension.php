...
class Extension extends AbstractPluginIntegration {
	...
	public static function source_text( $text, Payment $payment ) {
		$text = __( 'Formidable Forms', 'pronamic-ideal' ) . '<br />';
	...
	public function source_description( $description, Payment $payment ) {
		return __( 'Formidable Forms Entry', 'pronamic-ideal' );
	}
	...
	public function redirect_for_payment( $entry_id, $form_id ) {
		...
		$payment->title = \sprintf(
			...
			\sprintf(
				...
				__( 'Formidable entry %s', 'pronamic-ideal' ),
				$entry_id
			)
		);
	...
	public static function add_payment_trigger( $triggers ) {
		$triggers['pronamic-pay-pending']   = __( 'Pronamic payment pending', 'pronamic-ideal' );
		$triggers['pronamic-pay-success']   = __( 'Pronamic payment success', 'pronamic-ideal' );
		$triggers['pronamic-pay-cancelled'] = __( 'Pronamic payment cancelled', 'pronamic-ideal' );
		$triggers['pronamic-pay-expired']   = __( 'Pronamic payment expired', 'pronamic-ideal' );
		$triggers['pronamic-pay-failed']    = __( 'Pronamic payment failed', 'pronamic-ideal' );
