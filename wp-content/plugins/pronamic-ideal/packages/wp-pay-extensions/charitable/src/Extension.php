...
class Extension extends AbstractPluginIntegration {
	...
	public function __construct() {
		parent::__construct(
			[
				'name' => __( 'Charitable', 'pronamic-ideal' ),
			]
		);
	...
	public function source_text( $text, Payment $payment ) {
		$text = __( 'Charitable', 'pronamic-ideal' ) . '<br />';

		$text .= sprintf(
			'<a href="%s">%s</a>',
			get_edit_post_link( (int) $payment->source_id ),
			/* translators: %s: source id */
			sprintf( __( 'Donation %s', 'pronamic-ideal' ), $payment->source_id )
		);
	...
	public function source_description( $description, Payment $payment ) {
		return __( 'Charitable Donation', 'pronamic-ideal' );
	}
