...
class Extension extends AbstractPluginIntegration {
	...
	public function field_type_sections( $sections ) {
		$sections['pronamic_pay'] = [
			'id'         => 'pronamic_pay',
			'nicename'   => __( 'Pronamic Pay', 'pronamic-ideal' ),
			'fieldTypes' => [],
		];
	...
	public function source_text( $text, Payment $payment ) {
		$text = __( 'Ninja Forms', 'pronamic-ideal' ) . '<br />';
		...
		if ( 'nf_sub' === get_post_type( $source_id ) ) {
			$text .= sprintf(
				...
				sprintf( __( 'Entry #%s', 'pronamic-ideal' ), $source_id )
			);
		} else {
			/* translators: %s: payment source id */
			$text .= sprintf( __( '#%s', 'pronamic-ideal' ), $source_id );
		}
	...
	public function source_description( $description, Payment $payment ) {
		$description = __( 'Ninja Forms', 'pronamic-ideal' );
		...
		if ( 'nf_sub' === get_post_type( $source_id ) ) {
			$description = __( 'Ninja Forms Entry', 'pronamic-ideal' );
		}
