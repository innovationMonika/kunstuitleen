...
class AdminPaymentFormPostType {
	...
	public function edit_columns( $columns ) {
		$columns = [
			...
			'pronamic_pay_gf_form'                    => __( 'Form', 'pronamic-ideal' ),
			'pronamic_pay_gf_config'                  => __( 'Configuration', 'pronamic-ideal' ),
			'pronamic_pay_gf_transaction_description' => __( 'Transaction Description', 'pronamic-ideal' ),
