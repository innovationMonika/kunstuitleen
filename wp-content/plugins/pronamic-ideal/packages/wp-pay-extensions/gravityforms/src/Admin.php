...
class Admin {
	...
	public static function custom_merge_tags( $merge_tags ) {
		// Payment.
		$merge_tags[] = [
			'label' => __( 'Payment Status', 'pronamic-ideal' ),
			'tag'   => '{payment_status}',
		];

		$merge_tags[] = [
			'label' => __( 'Payment Date', 'pronamic-ideal' ),
			'tag'   => '{payment_date}',
		];
		...
		$merge_tags[] = [
			'label' => __( 'Pronamic Payment ID', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_id}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic Pay Again URL', 'pronamic-ideal' ),
			'tag'   => '{pronamic_pay_again_url}',
		];

		// Bank transfer.
		$merge_tags[] = [
			'label' => __( 'Pronamic bank transfer recipient reference', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_bank_transfer_recipient_reference}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic bank transfer recipient bank name', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_bank_transfer_recipient_bank_name}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic bank transfer recipient name', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_bank_transfer_recipient_name}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic bank transfer recipient IBAN', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_bank_transfer_recipient_iban}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic bank transfer recipient BIC', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_bank_transfer_recipient_bic}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic bank transfer recipient city', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_bank_transfer_recipient_city}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic bank transfer recipient country', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_bank_transfer_recipient_country}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic bank transfer recipient account number', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_bank_transfer_recipient_account_number}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic consumer bank account name', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_consumer_bank_account_name}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic consumer IBAN', 'pronamic-ideal' ),
			'tag'   => '{pronamic_payment_consumer_iban}',
		];

		// Subscription.
		$merge_tags[] = [
			'label' => __( 'Pronamic Subscription ID', 'pronamic-ideal' ),
			'tag'   => '{pronamic_subscription_id}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic Subscription Payment ID', 'pronamic-ideal' ),
			'tag'   => '{pronamic_subscription_payment_id}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic Subscription Amount', 'pronamic-ideal' ),
			'tag'   => '{pronamic_subscription_amount}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic Subscription Cancel URL', 'pronamic-ideal' ),
			'tag'   => '{pronamic_subscription_cancel_url}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic Subscription Renew URL', 'pronamic-ideal' ),
			'tag'   => '{pronamic_subscription_renew_url}',
		];

		$merge_tags[] = [
			'label' => __( 'Pronamic Subscription Renewal Date', 'pronamic-ideal' ),
	...
	public static function maybe_redirect_to_entry() {
		...
		if ( false === $lead ) {
			\wp_die( \esc_html__( 'The requested Gravity Forms entry could not be found.', 'pronamic-ideal' ) );
		}
