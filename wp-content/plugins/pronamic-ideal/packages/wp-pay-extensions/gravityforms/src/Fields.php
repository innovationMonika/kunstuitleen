	...
	public static function add_pay_field_group( $field_groups ) {
		if ( ! isset( $field_groups['pronamic_pay_fields'] ) ) {
			$field_groups['pronamic_pay_fields'] = [
				...
				'label'  => __( 'Payment Fields', 'pronamic-ideal' ),
				'fields' => [],
			];
		}
	...
	public function field_standard_settings( $position, $form_id ) {
		...
		<li class="pronamic_pay_config_field_setting field_setting">
			<label for="pronamic_pay_config_field" class="section_label">
				<?php \esc_html_e( 'Payment Gateway Configuration', 'pronamic-ideal' ); ?>
			...
			<select id="pronamic_pay_config_field"
				...
				<option value=""><?php \esc_html_e( '— Use Payment Feed Setting —', 'pronamic-ideal' ); ?></option>
				<?php
		...
		<li class="pronamic_pay_display_field_setting field_setting">
			<label for="pronamic_pay_display_field" class="section_label">
				<?php \esc_html_e( 'Display Mode', 'pronamic-ideal' ); ?>
			...
			<select id="pronamic_pay_display_field" onchange="SetFieldProperty( 'pronamicPayDisplayMode', jQuery( this ).val() );" class="fieldwidth-3">
				<option value=""><?php \esc_html_e( '— Use field default —', 'pronamic-ideal' ); ?></option>
				<option value="select"><?php echo \esc_html_x( 'Select', 'Field display mode', 'pronamic-ideal' ); ?></option>
				<option value="icons-24"><?php echo \esc_html_x( 'List with icons', 'Field display mode', 'pronamic-ideal' ); ?></option>
				<option value="icons-64"><?php echo \esc_html_x( 'Small icons', 'Field display mode', 'pronamic-ideal' ); ?></option>
				<option value="icons-125"><?php echo \esc_html_x( 'Large icons', 'Field display mode', 'pronamic-ideal' ); ?></option>
			</select>
		</li>
		<?php
	}
