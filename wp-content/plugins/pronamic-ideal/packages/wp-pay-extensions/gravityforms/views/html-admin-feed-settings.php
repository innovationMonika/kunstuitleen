...
<div id="gf-pay-feed-editor">
	...
	<div class="pronamic-pay-tabs">
		...
		<ul class="pronamic-pay-tabs-items">
			<li><?php esc_html_e( 'General', 'pronamic-ideal' ); ?></li>
			<li><?php esc_html_e( 'Status pages', 'pronamic-ideal' ); ?></li>
			<li><?php esc_html_e( 'Subscription', 'pronamic-ideal' ); ?></li>
			<li><?php esc_html_e( 'Fields', 'pronamic-ideal' ); ?></li>
			<li><?php esc_html_e( 'Advanced', 'pronamic-ideal' ); ?></li>
		</ul>
		...
		<div class="pronamic-pay-tab">
			...
			<table class="pronamic-pay-table-striped form-table">
				...
				<tr>
					<th scope="row">
						<label for="_pronamic_pay_gf_order_id">
							<?php esc_html_e( 'Order ID', 'pronamic-ideal' ); ?>
						</label>

						<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php esc_attr_e( 'Order ID.', 'pronamic-ideal' ); ?>"></span>
					</th>
					<td>
						...
						<span class="description pronamic-pay-description">
							...
							<?php esc_html_e( 'An order ID makes it easier to match payments from transaction overviews to a form and is required by some payment providers.', 'pronamic-ideal' ); ?>
						</span>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="_pronamic_pay_gf_transaction_description">
							<?php esc_html_e( 'Transaction Description', 'pronamic-ideal' ); ?>
						</label>

						<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php esc_attr_e( 'Transaction description that will be send with the payment. Use tags to customize the description.', 'pronamic-ideal' ); ?>"></span>
					</th>
					<td>
						<?php
						...
						<span class="description pronamic-pay-description">
							...
							<?php esc_html_e( 'A description which uses tags and results in more than 32 characters will be truncated.', 'pronamic-ideal' ); ?>
						</span>
					</td>
				</tr>
				...
				if ( count( $notifications ) > 0 ) :
					...
					<tr>
						<th scope="row">
							<?php esc_html_e( 'Send Notifications Delay', 'pronamic-ideal' ); ?>

							<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php esc_attr_e( 'Notifications for which sending will be delayed until the payment has been received.', 'pronamic-ideal' ); ?>"></span>
						</th>
						<td>
							<p>
								<?php esc_html_e( 'Delay sending notifications until payment has been received.', 'pronamic-ideal' ); ?>
							</p>
				...
				<tr>
					<th scope="row">
						<?php esc_html_e( 'Delay actions', 'pronamic-ideal' ); ?>

						<span class="dashicons dashicons-editor-help pronamic-pay-tip" title="<?php esc_attr_e( 'Actions for which execution will be delayed until the payment has been received.', 'pronamic-ideal' ); ?>"></span>
					</th>
					<td>
						<p>
							<?php esc_html_e( 'Delay actions until payment has been received.', 'pronamic-ideal' ); ?>
						</p>
						...
						<ul>
							<li>
								...
								<label for="_pronamic_pay_gf_delay_post_creation">
									<?php esc_html_e( 'Creating a post', 'pronamic-ideal' ); ?>
								</label>
							</li>
		...
		<div class="pronamic-pay-tab">
			...
			<table class="pronamic-pay-table-striped form-table pronamic-gf-links-tab">
				...
				$fields = [
					Links::SUCCESS => __( 'Success', 'pronamic-ideal' ),
					Links::CANCEL  => __( 'Cancelled', 'pronamic-ideal' ),
					Links::EXPIRED => __( 'Expired', 'pronamic-ideal' ),
					Links::ERROR   => __( 'Error', 'pronamic-ideal' ),
					Links::OPEN    => __( 'Open', 'pronamic-ideal' ),
				];
								...
								<ul style="margin: 0;">
									<li style="margin: 0;">
										<label>
											...
											<?php esc_html_e( 'Confirmation:', 'pronamic-ideal' ); ?>
										</label>
										...
										printf(
											...
											\esc_html__( '— Select Confirmation —', 'pronamic-ideal' )
										);
									...
									<li style="margin: 0;">
										<label>
											...
											<?php esc_html_e( 'Page:', 'pronamic-ideal' ); ?>
										</label>
										...
										wp_dropdown_pages(
											[
												...
												'show_option_none' => esc_html__( '— Select Page —', 'pronamic-ideal' ),
											]
										);
									...
									<li style="margin: 0;">
										<label>
											...
											<?php esc_html_e( 'URL:', 'pronamic-ideal' ); ?>
										</label>
		...
		<div class="pronamic-pay-tab">
			<div class="pronamic-pay-tab-block">
				<?php esc_html_e( 'Set the subscription details for recurring payments.', 'pronamic-ideal' ); ?>
			</div>
			...
			<table class="pronamic-pay-table-striped form-table pronamic-gf-subscription-tab">
				<tr>
					<th scope="row">
						<label>
							<?php esc_html_e( 'Recurring amount', 'pronamic-ideal' ); ?>
						</label>
					</th>
					<td>
						<fieldset>
							<legend class="screen-reader-text">
								<span><?php esc_html_e( 'Recurring amount', 'pronamic-ideal' ); ?></span>
							</legend>
							...
							<ul class="pronamic-pay-gf-form-choice-list">
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_amount_type_none">
										<?php esc_html_e( 'None', 'pronamic-ideal' ); ?>
									</label>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_amount_type_total">
										<?php esc_html_e( 'Total Amount', 'pronamic-ideal' ); ?>
									</label>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_amount_type_field">
										<?php esc_html_e( 'Form Field', 'pronamic-ideal' ); ?>
									</label>
				...
				<tr>
					<th scope="row">
						<label>
							<?php esc_html_e( 'Interval', 'pronamic-ideal' ); ?>
						</label>
					</th>
					<td>
						<fieldset>
							<legend class="screen-reader-text">
								<span><?php esc_html_e( 'Interval', 'pronamic-ideal' ); ?></span>
							</legend>
							...
							<ul class="pronamic-pay-gf-form-choice-list">
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_interval_type_fixed">
										<?php esc_html_e( 'Fixed', 'pronamic-ideal' ); ?>
									</label>

									<div class="pronamic-pay-gf-form-choice-checked">
										<?php echo esc_html( _x( 'Every', 'Recurring payment', 'pronamic-ideal' ) ); ?>
										...
										<select id="pronamic_pay_gf_subscription_interval_period" name="_pronamic_pay_gf_subscription_interval_period">
											<option value="D" <?php selected( $pay_feed->subscription_interval_period, 'D' ); ?>><?php esc_html_e( 'day(s)', 'pronamic-ideal' ); ?></option>
											<option value="W" <?php selected( $pay_feed->subscription_interval_period, 'W' ); ?>><?php esc_html_e( 'week(s)', 'pronamic-ideal' ); ?></option>
											<option value="M" <?php selected( $pay_feed->subscription_interval_period, 'M' ); ?>><?php esc_html_e( 'month(s)', 'pronamic-ideal' ); ?></option>
											<option value="Y" <?php selected( $pay_feed->subscription_interval_period, 'Y' ); ?>><?php esc_html_e( 'year(s)', 'pronamic-ideal' ); ?></option>
										</select>
									</div>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<div class="pronamic-pay-gf-form-choice-checked">
										...
										esc_html_e( 'days', 'pronamic-ideal' );
										...
										<p class="description pronamic-pay-description">
											...
											esc_html_e( 'Use a field value of 0 days for one-time payments.', 'pronamic-ideal' );
				...
				<tr>
					<th scope="row">
						<label>
							<?php esc_html_e( 'Number of Periods', 'pronamic-ideal' ); ?>
						</label>
					</th>
					<td>
						<fieldset>
							<legend class="screen-reader-text">
								<span><?php esc_html_e( 'Number of Periods', 'pronamic-ideal' ); ?></span>
							</legend>
							...
							<ul class="pronamic-pay-gf-form-choice-list">
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_frequency_type_unlimited">
										<?php echo esc_html_x( 'Unlimited', 'Recurring payment', 'pronamic-ideal' ); ?>
									</label>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<div class="pronamic-pay-gf-form-choice-checked">
										...
										<?php echo esc_html( _x( 'times', 'Recurring payment', 'pronamic-ideal' ) ); ?>
									</div>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<div class="pronamic-pay-gf-form-choice-checked">
										...
										echo esc_html( _x( 'times', 'Recurring payment', 'pronamic-ideal' ) );
				...
				<tr>
					<th scope="row">
						<label>
							<?php esc_html_e( 'Trial Period', 'pronamic-ideal' ); ?>
						</label>
					</th>
					<td>
						<?php
						...
						<fieldset>
							<legend class="screen-reader-text">
								<span><?php esc_html_e( 'Trial Period', 'pronamic-ideal' ); ?></span>
							</legend>
							...
							<div class="pronamic-pay-gf-form-choice">
								...
								<label for="pronamic_pay_gf_subscription_trial_enabled">
									<?php esc_html_e( 'Enable trial period', 'pronamic-ideal' ); ?>
								</label>

								<div class="pronamic-pay-gf-form-choice-checked">
									<label for="pronamic_pay_gf_subscription_trial_length">
										<?php esc_html_e( 'Length', 'pronamic-ideal' ); ?>
									</label>
									...
									<select id="pronamic_pay_gf_subscription_trial_length_unit" name="_pronamic_pay_gf_subscription_trial_length_unit">
										<option value="D" <?php selected( $trial->length_unit, 'D' ); ?>><?php esc_html_e( 'day(s)', 'pronamic-ideal' ); ?></option>
										<option value="W" <?php selected( $trial->length_unit, 'W' ); ?>><?php esc_html_e( 'week(s)', 'pronamic-ideal' ); ?></option>
										<option value="M" <?php selected( $trial->length_unit, 'M' ); ?>><?php esc_html_e( 'month(s)', 'pronamic-ideal' ); ?></option>
										<option value="Y" <?php selected( $trial->length_unit, 'Y' ); ?>><?php esc_html_e( 'year(s)', 'pronamic-ideal' ); ?></option>
									</select>
				...
				<tr>
					<th scope="row">
						<label>
							<?php esc_html_e( 'Payment Date Alignment', 'pronamic-ideal' ); ?>
						</label>
					</th>
					<td>
						<fieldset>
							<legend class="screen-reader-text">
								<span><?php esc_html_e( 'Payment Date Alignment', 'pronamic-ideal' ); ?></span>
							</legend>
							...
							<ul class="pronamic-pay-gf-form-choice-list">
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_interval_date_type_payment_date">
										<?php esc_html_e( 'Entry Date', 'pronamic-ideal' ); ?>
									</label>
								</li>
								<li class="pronamic-pay-gf-form-choice">
									...
									<label for="pronamic_pay_gf_subscription_interval_date_type_field">
										...
										<span class="pronamic-pay-gf-subscription-interval-date-sync-settings interval-D">
											<?php esc_html_e( 'Not Available', 'pronamic-ideal' ); ?>
										</span>
										...
										<span class="pronamic-pay-gf-subscription-interval-date-sync-settings interval-M">
											...
											echo wp_kses(
												sprintf(
													...
													__( 'On the %s <sup>th</sup> day of the month', 'pronamic-ideal' ),
													$select
												),
												$allowed_html
											);
									...
									<div class="pronamic-pay-gf-form-choice-checked">
										...
										<label for="pronamic_pay_gf_subscription_interval_date_prorate">
											...
											esc_html_e( 'Prorate the amount of the alignment period.', 'pronamic-ideal' );
		...
		<div class="pronamic-pay-tab">
			<div class="pronamic-pay-tab-block">
				<?php esc_html_e( 'Set corresponding form fields to include user data in the payment data with some payment providers.', 'pronamic-ideal' ); ?>
			</div>

			<?php

			$fields = [
				'prefix_name'                => __( 'Prefix Name', 'pronamic-ideal' ),
				'first_name'                 => __( 'First Name', 'pronamic-ideal' ),
				'middle_name'                => __( 'Middle Name', 'pronamic-ideal' ),
				'last_name'                  => __( 'Last Name', 'pronamic-ideal' ),
				'suffix_name'                => __( 'Suffix Name', 'pronamic-ideal' ),
				'address1'                   => __( 'Address', 'pronamic-ideal' ),
				'address2'                   => __( 'Address 2', 'pronamic-ideal' ),
				'zip'                        => __( 'Zip', 'pronamic-ideal' ),
				'city'                       => __( 'City', 'pronamic-ideal' ),
				'state'                      => __( 'State', 'pronamic-ideal' ),
				'country'                    => __( 'Country', 'pronamic-ideal' ),
				'telephone_number'           => __( 'Telephone Number', 'pronamic-ideal' ),
				'email'                      => __( 'Email', 'pronamic-ideal' ),
				'consumer_bank_details_name' => __( 'Account Holder Name', 'pronamic-ideal' ),
				'consumer_bank_details_iban' => __( 'Account IBAN', 'pronamic-ideal' ),
				'company_name'               => __( 'Company Name', 'pronamic-ideal' ),
				'vat_number'                 => __( 'VAT Number', 'pronamic-ideal' ),
			];
					...
					<tr>
						...
						<td>
							...
							if ( in_array( $name, [ 'prefix_name', 'first_name', 'middle_name', 'last_name', 'suffix_name' ], true ) ) {
								$auto_option_label = __( '— From first name field —', 'pronamic-ideal' );
							} elseif ( in_array( $name, [ 'address1', 'address2', 'zip', 'city', 'state', 'country' ], true ) ) {
								$auto_option_label = __( '— From first address field —', 'pronamic-ideal' );
							} elseif ( 'telephone_number' === $name ) {
								$auto_option_label = __( '— First phone field —', 'pronamic-ideal' );
							} elseif ( 'email' === $name ) {
								$auto_option_label = __( '— First email address field —', 'pronamic-ideal' );
							}
		...
		<div class="pronamic-pay-tab">
			<div class="pronamic-pay-tab-block">
				<?php esc_html_e( 'Optional settings for advanced usage only.', 'pronamic-ideal' ); ?>
			</div>
				...
				<tr>
					<th scope="row">
						<label for="gf_ideal_condition_field_id">
							<?php esc_html_e( 'Conditional Logic', 'pronamic-ideal' ); ?>
						</label>
					</th>
					<td>
						<div id="gf_ideal_condition_config">
							...
							$field = [
								...
								'label' => __( 'Conditional Logic', 'pronamic-ideal' ),
								'type'  => 'feed_condition',
							];
						...
						<p class="description pronamic-pay-description">
							<?php esc_html_e( 'Set conditional logic to only use this gateway if the entry matches the condition(s).', 'pronamic-ideal' ); ?>
						</p>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="gf_ideal_user_role_field_id">
							<?php esc_html_e( 'Update user role', 'pronamic-ideal' ); ?>
						</label>
					</th>
					<td>
						<?php
						...
						_pronamic_pay_gravityforms_dropdown_input(
							...
							[
								...
								'options'  => [
									'' => \__( '— Select Field —', 'pronamic-ideal' ),
								],
							]
						);
