...
<form method="post" action="">
	...
	if ( null !== $message ) {
		// Notice.
		$msg   = __( 'There was an error updating this payment feed.', 'pronamic-ideal' );
		$class = 'error';

		if ( '1' === $message ) {
			$class = 'updated';
			$msg   = __( 'Payment feed updated successfully.', 'pronamic-ideal' );
		}
	...
	<div id="titlediv">
		<div id="titlewrap">
			...
			$title_placeholder = __( 'Enter title here', 'pronamic-ideal' );
