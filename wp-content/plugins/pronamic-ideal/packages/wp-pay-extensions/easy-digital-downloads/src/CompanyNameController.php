...
class CompanyNameController {
	...
	public function setup() {
		...
		if ( function_exists( '\edd_add_email_tag' ) ) {
			\edd_add_email_tag(
				'company_name',
				\__( 'The company name', 'pronamic-ideal' ),
	...
	public function admin_init() {
		...
		\add_settings_section(
			'pronamic_pay_edd',
			\__( 'Easy Digital Downloads', 'pronamic-ideal' ),
			'__return_false',
			'pronamic_pay'
		);
		...
		\add_settings_field(
			'pronamic_pay_edd_company_name_field_enable',
			\__( 'Add company name field', 'pronamic-ideal' ),
			[ $this, 'input_checkbox' ],
			'pronamic_pay',
			'pronamic_pay_edd',
			[
				'legend'      => \__( 'Add company name field', 'pronamic-ideal' ),
				'description' => \__( 'Add company name field to purchase form fields', 'pronamic-ideal' ),
	...
	public function purchase_form() {
		...
		<fieldset class="pronamic-edd-fieldset">
			...
			<div class="" id="pronamic-edd-company-name-control">
				...
				<span class="edd-description"><?php \esc_html_e( 'Enter the name of your company.', 'pronamic-ideal' ); ?></span>
	...
	public function purchase_form_required_fields( $required_fields ) {
		$required_fields['edd_company'] = [
			...
			'error_message' => \__( 'Please enter your company name', 'pronamic-ideal' ),
		];
	...
	public function edd_payment_view_details( $payment_id ) {
		...
		<div class="column-container" style="margin-top: 1em;">
			<div class="column">
				<strong><?php \esc_html_e( 'Company:', 'pronamic-ideal' ); ?></strong><br />
	...
	public function edd_export_csv_cols_payments( $cols ) {
		$cols['company'] = \__( 'Company', 'pronamic-ideal' );
