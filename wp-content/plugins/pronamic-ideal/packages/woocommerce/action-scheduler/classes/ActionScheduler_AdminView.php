...
class ActionScheduler_AdminView extends ActionScheduler_AdminView_Deprecated {
	...
	public function register_system_status_tab( array $tabs ) {
		$tabs['action-scheduler'] = __( 'Scheduled Actions', 'pronamic-ideal' );
	...
	public function register_menu() {
		$hook_suffix = add_submenu_page(
			'tools.php',
			__( 'Scheduled Actions', 'pronamic-ideal' ),
			__( 'Scheduled Actions', 'pronamic-ideal' ),
			'manage_options',
			'action-scheduler',
	...
	public function add_help_tabs() {
		...
		$screen->add_help_tab(
			array(
				...
				'title'   => __( 'Columns', 'pronamic-ideal' ),
				'content' =>
					...
					sprintf( '<li><strong>%1$s</strong>: %2$s</li>', __( 'Scheduled', 'pronamic-ideal' ), __( 'The date/time the action is/was scheduled to run.', 'pronamic-ideal' ) ) .
					sprintf( '<li><strong>%1$s</strong>: %2$s</li>', __( 'Log', 'pronamic-ideal' ), __( 'Activity log for the action.', 'pronamic-ideal' ) ) .
					'</ul>',
			)
		);
	}
