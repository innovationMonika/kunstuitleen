...
$states = [
	PaymentStatus::OPEN       => _x( 'Pending', 'Payment status', 'pronamic-ideal' ),
	PaymentStatus::ON_HOLD    => _x( 'On Hold', 'Payment status', 'pronamic-ideal' ),
	PaymentStatus::SUCCESS    => _x( 'Completed', 'Payment status', 'pronamic-ideal' ),
	PaymentStatus::CANCELLED  => _x( 'Cancelled', 'Payment status', 'pronamic-ideal' ),
	PaymentStatus::REFUNDED   => _x( 'Refunded', 'Payment status', 'pronamic-ideal' ),
	PaymentStatus::FAILURE    => _x( 'Failed', 'Payment status', 'pronamic-ideal' ),
	PaymentStatus::EXPIRED    => _x( 'Expired', 'Payment status', 'pronamic-ideal' ),
	PaymentStatus::AUTHORIZED => _x( 'Authorized', 'Payment status', 'pronamic-ideal' ),
];
	...
	<div class="pronamic-pay-minor-actions">
		...
		if ( null !== $gateway && $gateway->supports( 'payment_status_request' ) ) {
			...
			printf(
				...
				esc_url( $action_url ),
				esc_html__( 'Check status', 'pronamic-ideal' )
			);
		}
