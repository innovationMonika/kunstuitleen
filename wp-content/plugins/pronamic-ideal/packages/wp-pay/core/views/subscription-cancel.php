...
<html <?php language_attributes(); ?>>
	<head>
		...
		<title><?php esc_html_e( 'Subscription Cancellation', 'pronamic-ideal' ); ?></title>
	...
	<body>
		<div class="pronamic-pay-redirect-page">
			<div class="pronamic-pay-redirect-container">
				<h1><?php esc_html_e( 'Subscription Cancellation', 'pronamic-ideal' ); ?></h1>
				...
				<div class="pp-page-section-container">
					<div class="pp-page-section-wrapper alignleft">
						...
						<?php if ( SubscriptionStatus::ACTIVE !== $subscription->get_status() ) : ?>
							...
							<p>
								<?php esc_html_e( 'The subscription can not be canceled as it is not active anymore.', 'pronamic-ideal' ); ?>
							</p>
					...
					<?php if ( SubscriptionStatus::ACTIVE === $subscription->get_status() ) : ?>
						...
						<div class="pp-page-section-wrapper">
							...
							<p>
								<?php esc_html_e( 'Are you sure you want to cancel the subscription?', 'pronamic-ideal' ); ?>
							</p>
							...
							<form id="pronamic_ideal_form" name="pronamic_ideal_form" method="post">
								...
								<input type="submit" value="<?php esc_attr_e( 'Cancel subscription', 'pronamic-ideal' ); ?>" />
							</form>
