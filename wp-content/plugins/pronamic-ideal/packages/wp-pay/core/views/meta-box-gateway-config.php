		...
		<tr>
			<th scope="row">
				<label for="pronamic_gateway_id">
					<?php esc_html_e( 'Payment provider', 'pronamic-ideal' ); ?>
				</label>
			</th>
			<td>
				<select id="pronamic_gateway_id" name="_pronamic_gateway_id">
					...
					foreach ( $integrations as $integration ) {
						...
						if ( $integration->deprecated ) {
							...
							$name = sprintf( __( '%s (obsoleted)', 'pronamic-ideal' ), $name );
						...
						if ( null !== $integration->get_product_url() ) {
							$links[] = sprintf(
								...
								\esc_html__( 'Product information', 'pronamic-ideal' )
							);
						}
						...
						if ( null !== $manual_url ) {
							$links[] = sprintf(
								...
								\esc_html__( 'Manual', 'pronamic-ideal' )
							);
						}
