...
<html <?php language_attributes(); ?>>
	<head>
		...
		<title><?php esc_html_e( 'Subscription Renewal', 'pronamic-ideal' ); ?></title>
	...
	<body>
		<div class="pronamic-pay-redirect-page">
			<div class="pronamic-pay-redirect-container">
				<h1><?php esc_html_e( 'Subscription Renewal', 'pronamic-ideal' ); ?></h1>
				...
				<div class="pp-page-section-container">
					<div class="pp-page-section-wrapper alignleft">
						...
						<?php if ( null === $next_period ) : ?>
							...
							<p>
								<?php echo esc_html__( 'This subscription can not be renewed.', 'pronamic-ideal' ); ?>
							</p>
						...
						<?php else : ?>
							...
							<p>
								...
								printf(
									...
									esc_html( __( 'Renew the subscription by paying for the period %s.', 'pronamic-ideal' ) ),
									esc_html( $next_period->human_readable_range( __( 'l j F Y', 'pronamic-ideal' ), _x( 'until', 'period separator', 'pronamic-ideal' ) ) )
								);
