...
if ( empty( $lines ) ) : ?>
	...
	<p>
		<?php \esc_html_e( 'No payment lines found.', 'pronamic-ideal' ); ?>
	</p>
...
<?php else : ?>
	...
	<div class="pronamic-pay-table-responsive">
		<table class="pronamic-pay-table widefat">
			<thead>
				<tr>
					<th scope="col"><?php \esc_html_e( 'ID', 'pronamic-ideal' ); ?></th>
					<th scope="col"><?php \esc_html_e( 'SKU', 'pronamic-ideal' ); ?></th>
					<th scope="col"><?php \esc_html_e( 'Image', 'pronamic-ideal' ); ?></th>
					<th scope="col"><?php \esc_html_e( 'Name', 'pronamic-ideal' ); ?></th>
					<th scope="col">
						<?php

						\printf(
							'<span class="pronamic-pay-tip" title="%s">%s</span>',
							\esc_attr__( 'Unit price with discount including tax.', 'pronamic-ideal' ),
							\esc_html__( 'Unit Price', 'pronamic-ideal' )
						);

						?>
					</th>
					<th scope="col"><?php \esc_html_e( 'Quantity', 'pronamic-ideal' ); ?></th>
					<th scope="col">
						<?php

						\printf(
							'<span class="pronamic-pay-tip" title="%s">%s</span>',
							\esc_attr__( 'Total discount.', 'pronamic-ideal' ),
							\esc_html__( 'Discount', 'pronamic-ideal' )
						);
					...
					<th scope="col">
						...
						\printf(
							'<span class="pronamic-pay-tip" title="%s">%s</span>',
							\esc_attr__( 'Total amount with discount including tax.', 'pronamic-ideal' ),
							\esc_html__( 'Total Amount', 'pronamic-ideal' )
						);

						?>
					</th>
					<th scope="col"><?php \esc_html_e( 'Total Tax', 'pronamic-ideal' ); ?></th>
				</tr>
			</thead>
				...
				<?php foreach ( $lines as $line ) : ?>
					...
					<tr>
						...
						<td>
							...
							if ( null !== $unit_price ) {
								$tips = [
									\__( 'No tax information.', 'pronamic-ideal' ),
								];
								...
								if ( $unit_price instanceof TaxedMoney ) {
									$tips = [
										\sprintf(
											...
											\__( 'Exclusive tax: %s', 'pronamic-ideal' ),
											$unit_price->get_excluding_tax()
										),
										\sprintf(
											/* translators: %s: price including tax */
											\__( 'Inclusive tax: %s', 'pronamic-ideal' ),
