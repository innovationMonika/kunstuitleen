...
$states = [
	...
	'payment_completed' => __( '%s completed', 'pronamic-ideal' ),
	/* translators: %s: posts count value */
	'payment_pending'   => __( '%s pending', 'pronamic-ideal' ),
	/* translators: %s: posts count value */
	'payment_cancelled' => __( '%s cancelled', 'pronamic-ideal' ),
	/* translators: %s: posts count value */
	'payment_failed'    => __( '%s failed', 'pronamic-ideal' ),
	/* translators: %s: posts count value */
	'payment_expired'   => __( '%s expired', 'pronamic-ideal' ),
];
					...
					echo \wp_kses(
						\sprintf(
							...
							'<strong>' . \sprintf(
								...
								\_n( '%s payment', '%s payments', $count, 'pronamic-ideal' ),
