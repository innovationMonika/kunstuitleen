...
<html <?php language_attributes(); ?>>
	<head>
		...
		<title><?php esc_html_e( 'Change subscription payment method', 'pronamic-ideal' ); ?></title>
	...
	<body>
		<div class="pronamic-pay-redirect-page">
			<div class="pronamic-pay-redirect-container">
				...
				<h1>
					<?php \esc_html_e( 'Change subscription payment method', 'pronamic-ideal' ); ?>
				</h1>

				<?php if ( count( $mollie_customer_mandates ) > 0 ) : ?>

					<p>
						<?php \esc_html_e( 'Select an existing payment method or add a new one.', 'pronamic-ideal' ); ?>
					</p>
					...
					<div class="pp-card-slider-container">
						<div class="pp-card-slider-wrapper">
							<form method="post">
								<h2>
									<?php \esc_html_e( 'Select existing payment method', 'pronamic-ideal' ); ?>
								</h2>
											...
											<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>" style="background: <?php echo \esc_attr( $bg_color ); ?>;">
												...
												<div class="pp-card__content">
													...
													<dl class="pp-card__name">
														<dt class="pp-card__label"><?php echo esc_html_x( 'Name', 'Card selector', 'pronamic-ideal' ); ?></dt>
								...
								<p>
									...
									<input type="submit" value="<?php esc_attr_e( 'Use selected payment method', 'pronamic-ideal' ); ?>" />
								</p>
							</form>
						</div>
					</div>
				...
				<div class="pp-new-payment-method-container">
					<div class="pp-new-payment-method-wrapper">
						<form method="post">
							<h2>
								<?php \esc_html_e( 'Add new payment method', 'pronamic-ideal' ); ?>
							</h2>

							<label>
								<p>
									<?php esc_html_e( 'Select payment method for verification payment.', 'pronamic-ideal' ); ?>
								</p>
							...
							<p>
								...
								<input type="submit" value="<?php esc_attr_e( 'Pay', 'pronamic-ideal' ); ?>" />
							</p>
						</form>
					</div>
				</div>
