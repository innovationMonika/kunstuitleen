...
$sections = [
	...
	'payment_methods' => (object) [
		'title'  => __( 'Payment Methods', 'pronamic-ideal' ),
		'fields' => [
			[
				'section'  => 'payment_methods',
				'title'    => __( 'Supported Payment Methods', 'pronamic-ideal' ),
				'type'     => 'custom',
...
if ( $integration->supports( 'webhook' ) ) {
	$fields[] = [
		'section'  => 'feedback',
		'title'    => __( 'Webhook Status', 'pronamic-ideal' ),
		'type'     => 'custom',
...
if ( $integration->supports( 'webhook' ) && ! $integration->supports( 'webhook_no_config' ) ) {
	...
	if ( $webhook_config_needed ) {
		...
		$fields[] = [
			'section'  => 'general',
			'title'    => __( 'Transaction feedback', 'pronamic-ideal' ),
			'type'     => 'custom',
			'callback' => function () {
				printf(
					'⚠️ %s',
