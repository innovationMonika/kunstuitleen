...
<?php if ( empty( $phases ) ) : ?>
	...
	<?php esc_html_e( 'No phases found.', 'pronamic-ideal' ); ?>
		...
		<table class="pronamic-pay-table widefat">
			<thead>
				<tr>
					...
					<th scope="col"><?php esc_html_e( 'Recurrence', 'pronamic-ideal' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Start Date', 'pronamic-ideal' ); ?></th>
					<th scope="col"><?php esc_html_e( 'End Date', 'pronamic-ideal' ); ?></th>

					<?php if ( $has_trial ) : ?>

						<th scope="col"><?php esc_html_e( 'Trial', 'pronamic-ideal' ); ?></th>

					<?php endif; ?>

					<?php if ( $has_alignment ) : ?>

						<th scope="col"><?php esc_html_e( 'Aligned', 'pronamic-ideal' ); ?></th>
						<th scope="col"><?php esc_html_e( 'Prorated', 'pronamic-ideal' ); ?></th>
					...
					<tr>
						...
						<?php if ( $has_trial ) : ?>
							...
							<td>
								...
								echo esc_html( $phase->is_trial() ? __( 'Yes', 'pronamic-ideal' ) : __( 'No', 'pronamic-ideal' ) );
						...
						<?php if ( $has_alignment ) : ?>
							...
							<td>
								...
								echo esc_html( $phase->is_alignment() ? __( 'Yes', 'pronamic-ideal' ) : __( 'No', 'pronamic-ideal' ) );
							...
							<td>
								...
								echo esc_html( $phase->is_prorated() ? __( 'Yes', 'pronamic-ideal' ) : __( 'No', 'pronamic-ideal' ) );
