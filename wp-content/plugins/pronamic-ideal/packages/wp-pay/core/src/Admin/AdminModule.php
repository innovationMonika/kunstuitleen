...
class AdminModule {
	...
	public function admin_menu() {
		...
		$badges = [
			...
			'payments'      => [
				'title' => \sprintf(
					...
					\_n( '%d payment pending', '%d payments pending', $payments_pending_count, 'pronamic-ideal' ),
			...
			'subscriptions' => [
				'title' => \sprintf(
					...
					\_n( '%d subscription on hold', '%d subscriptions on hold', $subscriptions_on_hold_count, 'pronamic-ideal' ),
		...
		$submenu_pages[] = [
			'page_title' => __( 'Payments', 'pronamic-ideal' ),
			'menu_title' => __( 'Payments', 'pronamic-ideal' ) . $badges['payments']['html'],
		...
		if ( \in_array( 'subscriptions', $modules, true ) ) {
			$submenu_pages[] = [
				'page_title' => __( 'Subscriptions', 'pronamic-ideal' ),
				'menu_title' => __( 'Subscriptions', 'pronamic-ideal' ) . $badges['subscriptions']['html'],
				'capability' => 'edit_payments',
		...
		$submenu_pages[] = [
			'page_title' => __( 'Configurations', 'pronamic-ideal' ),
			'menu_title' => __( 'Configurations', 'pronamic-ideal' ),
			'capability' => 'manage_options',
			'menu_slug'  => 'edit.php?post_type=pronamic_gateway',
		];

		$submenu_pages[] = [
			'page_title' => __( 'Settings', 'pronamic-ideal' ),
		...
		if ( isset( $submenu['pronamic_ideal'] ) ) {
			...
			$submenu['pronamic_ideal'][0][0] = __( 'Dashboard', 'pronamic-ideal' );
		}
	}
