...
class PagesController {
	...
	public function settings_section() {
		...
		if ( \in_array( false, $statuses, true ) ) {
			\submit_button(
				\__( 'Set default pages', 'pronamic-ideal' ),
				'',
	...
	public function input_page( $args ) {
		...
		\wp_dropdown_pages(
			[
				...
				'show_option_none' => \esc_attr( \__( '— Select Page —', 'pronamic-ideal' ) ),
				'class'            => 'regular-text',
			]
		);
	}
	...
	public function get_pages() {
		return [
			[
				'post_title'   => \__( 'Payment Completed', 'pronamic-ideal' ),
				'post_name'    => \__( 'payment-completed', 'pronamic-ideal' ),
				'post_content' => \sprintf(
					'<p>%s</p>',
					\__( 'The payment has been successfully completed.', 'pronamic-ideal' )
				),
				'option_name'  => 'pronamic_pay_completed_page_id',
			],
			[
				'post_title'   => \__( 'Payment Canceled', 'pronamic-ideal' ),
				'post_name'    => \__( 'payment-canceled', 'pronamic-ideal' ),
				'post_content' => \sprintf(
					'<p>%s</p>',
					\__( 'You have canceled the payment.', 'pronamic-ideal' )
				),
				'option_name'  => 'pronamic_pay_cancel_page_id',
			],
			[
				'post_title'   => \__( 'Payment Expired', 'pronamic-ideal' ),
				'post_name'    => \__( 'payment-expired', 'pronamic-ideal' ),
				'post_content' => \sprintf(
					'<p>%s</p>',
					\__( 'Your payment session has expired.', 'pronamic-ideal' )
				),
				'option_name'  => 'pronamic_pay_expired_page_id',
			],
			[
				'post_title'   => \__( 'Payment Error', 'pronamic-ideal' ),
				'post_name'    => \__( 'payment-error', 'pronamic-ideal' ),
				'post_content' => \sprintf(
					'<p>%s</p>',
					\__( 'An error has occurred during payment.', 'pronamic-ideal' )
				),
				'option_name'  => 'pronamic_pay_error_page_id',
			],
			[
				'post_title'   => \__( 'Payment Status Unknown', 'pronamic-ideal' ),
				'post_name'    => \__( 'payment-unknown', 'pronamic-ideal' ),
				'post_content' => \sprintf(
					'<p>%s</p>',
					\__( 'The payment status is unknown.', 'pronamic-ideal' )
				),
				'option_name'  => 'pronamic_pay_unknown_page_id',
			],
			[
				'post_title'   => \__( 'Subscription Canceled', 'pronamic-ideal' ),
				'post_name'    => \__( 'subscription-canceled', 'pronamic-ideal' ),
				'post_content' => \sprintf(
					'<p>%s</p>',
					\__( 'The subscription has been canceled.', 'pronamic-ideal' )
				),
