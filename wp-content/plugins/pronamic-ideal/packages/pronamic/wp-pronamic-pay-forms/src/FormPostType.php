...
class FormPostType {
	...
	public function register_post_type() {
		register_post_type(
			self::POST_TYPE,
			[
				'label'              => __( 'Payment Forms', 'pronamic-ideal' ),
				'labels'             => [
					'name'                     => __( 'Payment Forms', 'pronamic-ideal' ),
					'singular_name'            => __( 'Payment Form', 'pronamic-ideal' ),
					'add_new'                  => __( 'Add New', 'pronamic-ideal' ),
					'add_new_item'             => __( 'Add New Payment Form', 'pronamic-ideal' ),
					'edit_item'                => __( 'Edit Payment Form', 'pronamic-ideal' ),
					'new_item'                 => __( 'New Payment Form', 'pronamic-ideal' ),
					'all_items'                => __( 'All Payment Forms', 'pronamic-ideal' ),
					'view_item'                => __( 'View Payment Form', 'pronamic-ideal' ),
					'search_items'             => __( 'Search Payment Forms', 'pronamic-ideal' ),
					'not_found'                => __( 'No payment forms found.', 'pronamic-ideal' ),
					'not_found_in_trash'       => __( 'No payment forms found in Trash.', 'pronamic-ideal' ),
					'menu_name'                => __( 'Payment Forms', 'pronamic-ideal' ),
					'filter_items_list'        => __( 'Filter payment forms list', 'pronamic-ideal' ),
					'items_list_navigation'    => __( 'Payment forms list navigation', 'pronamic-ideal' ),
					'items_list'               => __( 'Payment forms list', 'pronamic-ideal' ),

					/*
					 * New Post Type Labels in 5.0.
					 * @link https://make.wordpress.org/core/2018/12/05/new-post-type-labels-in-5-0/
					 */
					'item_published'           => __( 'Payment form published.', 'pronamic-ideal' ),
					'item_published_privately' => __( 'Payment form published privately.', 'pronamic-ideal' ),
					'item_reverted_to_draft'   => __( 'Payment form reverted to draft.', 'pronamic-ideal' ),
					'item_scheduled'           => __( 'Payment form scheduled.', 'pronamic-ideal' ),
					'item_updated'             => __( 'Payment form updated.', 'pronamic-ideal' ),
				],
				'public'             => true,
	...
	public function edit_columns( $columns ) {
		$columns = [
			...
			'pronamic_payment_form_gateway'   => __( 'Gateway', 'pronamic-ideal' ),
			'pronamic_payment_form_payments'  => __( 'Payments', 'pronamic-ideal' ),
			'pronamic_payment_form_earnings'  => __( 'Earnings', 'pronamic-ideal' ),
			'pronamic_payment_form_shortcode' => __( 'Shortcode', 'pronamic-ideal' ),
			'date'                            => __( 'Date', 'pronamic-ideal' ),
		];
	...
	public function add_meta_boxes( $post_type ) {
		if ( self::POST_TYPE === $post_type ) {
			add_meta_box(
				...
				__( 'Form Options', 'pronamic-ideal' ),
...
<div class="misc-pub-section">
	<label for="pronamic-pay-shortcode"><?php esc_html_e( 'Shortcode:', 'pronamic-ideal' ); ?></label>
