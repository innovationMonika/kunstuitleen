...
class Integration extends AbstractIntegration {
	...
	public function get_settings_fields() {
		...
		$fields[] = [
			...
			'title'    => __( 'Hash Key', 'pronamic-ideal' ),
			'type'     => 'text',
			'classes'  => [ 'regular-text', 'code' ],
			'tooltip'  => __( 'Hash key (also known as: key or secret key) as mentioned in the payment provider dashboard.', 'pronamic-ideal' ),
			'methods'  => [ 'ideal-basic' ],
		];
		...
		$fields[] = [
			...
			'title'    => _x( 'XML Notification URL', 'iDEAL Basic dashboard', 'pronamic-ideal' ),
			'type'     => 'text',
			'classes'  => [ 'regular-text', 'code' ],
