...
?>
<h2><?php esc_html_e( 'Mollie', 'pronamic-ideal' ); ?></h2>
...
<table class="form-table" id="fieldset-billing">
	<tbody>
		<tr>
			<th>
				<?php echo esc_html( _x( 'Customers', 'mollie', 'pronamic-ideal' ) ); ?>
			</th>
			<td>
				<table class="widefat striped pronamic-pay-mollie-customers-table">
					<thead>
						<tr>
							...
							<th scope="col"><?php \esc_html_e( 'Test', 'pronamic-ideal' ); ?></th>
							<th scope="col"><?php \esc_html_e( 'Name', 'pronamic-ideal' ); ?></th>
							<th scope="col"><?php \esc_html_e( 'Email', 'pronamic-ideal' ); ?></th>
						</tr>
					</thead>
					...
					<tbody>
						...
						<?php foreach ( $customers as $customer ) : ?>
							...
							<tr>
								...
								<td>
									<?php $customer->test_mode ? \esc_html_e( 'Yes', 'pronamic-ideal' ) : \esc_html_e( 'No', 'pronamic-ideal' ); ?>
								</td>
								<td>
