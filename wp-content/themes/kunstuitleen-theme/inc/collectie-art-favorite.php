<?php 
    ...
    $cols = '';
    if(!$cols){ 
        $cols = 'col-xs-12 col-sm-4 col-md-3 col-lg-3'; 
    }
?>
<article class="<?php echo $cols; ?> art"  draggable="true" ondragstart="drag(event)" id="<?php the_field('art_inventnr'); ?>">
    ...
    <section class="art-content text-center">
        ...
        <section class="favorite<?php if (in_array( get_the_ID(), $favorieten )) { echo ' active'; } ?>" id="<?php echo get_the_ID(); ?>" onclick="favorite_collective(this);return false;" data_drag='0'><span><?php echo $span; ?></span></section>
