<?php
   ...
   */    
      ...
      $ajax_last_loaded_page = 12; //get_cookie_value('ajax_last_loaded_page'); // prev: collectieCurrentPage        
      $currentPage = 1;     
...
<main class="flex-shrink-0 kunstenaars-font">
   <div class="container">
      <div class="kunstenaars-font_main">
         <section class="container col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="row text-center">
               ...
               <div>
                  <?php //if (have_posts()) : while (have_posts()) : the_post(); ?>
                  <label class="col"> <?php the_content(); ?></label>
                  <?php //endwhile; endif; ?>
               </div>
            </div>
         </section>
               ...
               <div class="tabbable-panel">
                  <div class="tabbable-line">
                     <ul class="nav nav-tabs nav-justified">
                        <li class="active"><a data-target="#tab1default" data-toggle="tab"><label class="collection-heading h4 text-uppercase mr-jonas"><strong><?php echo esc_html__( 'Collectie', 'kunstuitleen-theme' ); ?></strong></label></a></li>
                        <li id="drag_drop" ondrop="drop(event)" ondragover="allowDrop(event)"><a <?php  if($cookieWebVariant=='thuis'){?>href="/thuis/favorieten/?filters=true" <?php }else{ ?> href="/werk/mijn-favorieten/?filters=true" <?php } ?>><label id="div1" class="collection-heading h4 text-uppercase" onclick="favrate_collectie(this)"><strong><?php echo esc_html__( 'Mijn favorieten', 'kunstuitleen-theme' ); ?> (<span class="favorite-selection-count">0</span>)</strong></label></a></li>
                     </ul>
                  </div>
               </div>
            </section>
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="row">
                           <div class="col-xs-12 col-sm-5 col-lg-5 col-md-5">
                              <label class="h4 mr-jonas"><strong style="padding-right: 4px;">Collectie voor jou</strong><span class="badge bg-info" style="background-color: #428bca;width:25px;height:25px;line-height:25px; "><?php echo $totalFound; ?></span></label>
                           </div>
                           <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 text-center" id="filtersSearch">
                              <div class="filter-search" style="height: 48px;">
                                 <?php //$searched = safe_get('search'); ?>
                                 <input type="text" class="search_box" name="search-data" id="c"  value="" placeholder="Titel, nummer, etc..."  />
                                 <ul class="custom-autocomplete"></ul>
                                 <img src="<?php bloginfo('template_url');?>/static/images/filter-search.svg" style="height: 16px;width: 16px;" alt="Zoeken >" class="filter-submit" />
                        ...
                        <div class="row collection">
                           <div class="col-lg-2 col-md-3 collection_grid_tablet">
                              <section id="filters" class="">
                                 ...
                                 <input type="hidden" id="search_val" value="" name="c"/>
                                    <?php 
                                         $args = array(
                           ...
                           <div class="col-lg-1 d-lg-block d-none tablet_hide" style="width: 3%;"></div>
                              <section class="container-fluid ajaxloading collection_grid_tablet_group" id="collectie">
                                 ...
                                 <aside class="end-message text-center<?php echo ($totalFound == 0 ? ' show' : ''); ?>">
                                    <?php echo esc_html__( 'Er zijn geen kunstwerken (meer) gevonden die aan uw zoekcriteria voldoen. Probeer het gerust opnieuw door uw zoekopdracht aan te passen.', 'kunstuitleen-theme' ); ?>
                                 </aside>
                                 </div>
                              </section>
                        </div>
...
<script type="text/javascript">
   ...
   {
      valid = true;      
      if ( document.search_form.c.value.length < 3) {
